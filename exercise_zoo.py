...
class Zoo:
    ...
    def __init__(self, name: str, max_number_of_animals: int):
        ...
        """
        self.__name = name
        self.__max_number_of_animals = max_number_of_animals
        self.animals = []
    ...
    def can_add_animal(self, animal: Animal) -> bool:
        ...
        """
        can_add = True
        if len(self.animals) >= self.__max_number_of_animals or animal in self.animals:
            can_add = False
        if animal_in_zoo == animal.name and animal_in_zoo.specie == animal.specie:
            can_add = False
        return can_add
