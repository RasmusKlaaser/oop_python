...
class Hand:
    ...
    def is_straight(self):
        ...
        """
        is_striaght_bool = False
        self.str_to_int()
        self.cards.sort(key=lambda x: x.value)
        if len(self.cards) == 5:
            if self.cards[0].value == self.cards[1].value - 1 == self.cards[2].value - 2 == self.cards[3].value - 3 ==\
                self.cards[4].value - 4:
                is_striaght_bool = True
        self.int_to_str()
        return is_striaght_bool
    ...
    def is_straight_flush(self):
        ...
        """
        is_straight_flush_bool = False
        if self.is_straight() and self.is_flush():
            is_straight_flush_bool = True
        return is_straight_flush_bool
    ...
    def is_full_house(self):
        ...
        self.str_to_int()
        self.cards.sort(key=lambda x: x.value)
        if self.cards[0].value == self.cards[1].value == self.cards[2].value and self.cards[3].value == \
                self.cards[4].value or self.cards[0].value == self.cards[1].value and self.cards[2].value == \
    ...
    def is_four_of_a_kind(self):
        ...
        self.str_to_int()
        self.cards.sort(key=lambda x: x.value)
        if self.cards[0].value == self.cards[1].value == self.cards[2].value == self.cards[3].value or \
                self.cards[1].value == self.cards[2].value == self.cards[3].value == self.cards[4].value:
    ...
    def is_three_of_a_kind(self):
        ...
        self.str_to_int()
        self.cards.sort(key=lambda x: x.value)
        if self.cards[0].value == self.cards[1].value == self.cards[2].value or \
                self.cards[1].value == self.cards[2].value == self.cards[3].value or self.cards[2].value == self.cards[3].value == self.cards[4].value:
